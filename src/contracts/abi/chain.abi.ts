export const chainAbi = [
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_blockPadding', type: 'uint256' },
    ],
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'anchor', type: 'uint256' },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_items', type: 'uint256' },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'bytes32[]', name: '_keys', type: 'bytes32[]' },
  ...
  {
    inputs: [
      { internalType: 'bytes32', name: 'affidavit', type: 'bytes32' },
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'contract IStakingBank', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [
      { internalType: 'uint256[]', name: '_blockHeights', type: 'uint256[]' },
      { internalType: 'bytes', name: '_proofs', type: 'bytes' },
      {
        internalType: 'uint256[]',
        name: '_proofItemsCounter',
        type: 'uint256[]',
      },
      { internalType: 'bytes32[]', name: '_leaves', type: 'bytes32[]' },
    ],
    name: 'verifyProofs',
